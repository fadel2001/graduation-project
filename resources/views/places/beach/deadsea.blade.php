    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Dead Sea</h6>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            ...
                            <a class="btn btn-square mx-1" href="https://www.instagram.com/movenpickdeadsea?igsh=MThyMXF4MW9uaDdqdw=="><i class="fab fa-instagram"></i></a>
                        </div>
                        <div class="text-center p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        ...
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            <a class="btn btn-square mx-1" href="https://m.facebook.com/DeadSeaMarriott"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        ...
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            <a class="btn btn-square mx-1" href="https://www.facebook.com/Theresthousedeadsea?mibextid=LQQJ4d"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square mx-1" href="https://www.instagram.com/villaballi.deadsea?igsh=ZjA2aXdreTF0cnVo"><i class="fab fa-instagram"></i></a>
                        </div>
                        <div class="text-center p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        ...
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            <a class="btn btn-square mx-1" href="https://www.facebook.com/Santorini.deadsea?mibextid=LQQJ4d"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square mx-1" href="https://www.instagram.com/santorini_chalet?igsh=MXdoeTN2NjNseGQ5eg=="><i class="fab fa-instagram"></i></a>
                        </div>
                        <div class="text-center p-4">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="row g-4">
                    <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.3s">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13607.514856389449!2d35.489700249740935!3d31.500017433358472!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15033e161d39163d%3A0xce27b8579b4f483d!2sDead%20Sea!5e0!3m2!1sen!2sbd!4v1716151904298!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                    </div>
                </div>
            </div>
        </div>
    </div>
