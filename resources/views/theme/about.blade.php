...
<head>
    ...
    <link href="{{ asset('assets') }}/js/animate/animate.min.css" rel="stylesheet">
    <link href="{{ asset('assets') }}/js/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="{{ asset('assets') }}/js/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />
...
<body>
    ...
    <script src="{{ asset('assets') }}/js/waypoints/waypoints.min.js"></script>
    <script src="{{ asset('assets') }}/js/owlcarousel/owl.carousel.min.js"></script>
    <script src="{{ asset('assets') }}/js/tempusdominus/js/moment.min.js"></script>
    <script src="{{ asset('assets') }}/js/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="{{ asset('assets') }}/js/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
