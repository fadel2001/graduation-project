...
@section('search-area')
    <div class="mx-auto position-relative w-75 animated slideInDown">
        <input class="py-3 border-0 form-control rounded-pill w-100 ps-4 pe-5" type="text" placeholder="Eg: Petra">
        <button type="button" class="top-0 px-4 py-2 btn btn-primary rounded-pill position-absolute end-0 me-2"
...
@section('content')
    ...
    <div class="py-5 container-xxl">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="px-3 text-center bg-white section-title text-primary">Travel airlines</h6>
